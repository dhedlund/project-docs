...
- **Discrepancy** — the help center says plan upgrades are free until the next cycle;
  the code prorates immediately (BILL-1423). Get the help article fixed. (See
  `Plan upgrade` Discrepancy callout.)
